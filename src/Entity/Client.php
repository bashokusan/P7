...
class Client implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\ProductUser", mappedBy="client")
     */
    ...
    public function addProductUser(ProductUser $productUser): self
    {
    ...
    public function removeProductUser(ProductUser $productUser): self
    {
        if ($this->productUsers->contains($productUser)) {
            $this->productUsers->removeElement($productUser);
            // set the owning side to null (unless already changed)
            if ($productUser->getClient() === $this) {
